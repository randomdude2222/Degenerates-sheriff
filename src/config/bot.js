...
export const botConfig = {
  ...
  commands: {
    ...
    owners: process.env.OWNER_IDS?.split("1327100379241906208,953832618481303592") || [],
  ...
  applications: {
    ...
    managerRoles: [1507050608069316811], // Will be populated from environment or database
  },
